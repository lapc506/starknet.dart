...
- Install starknet-devnet 0.4.2
```sh
asdf install starknet-devnet 0.4.2
asdf global starknet-devnet 0.4.2
```

- Install starkli 0.4.2
```sh
...
5. Create `lib/services/counter_service.dart` with the following content. Replace contractAddress value with the contract address obtained from the previous deploy step:
